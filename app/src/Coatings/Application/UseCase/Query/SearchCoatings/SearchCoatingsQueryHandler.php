 ...
 *
 * Проекция Coating → CoatingSuggestDTO вынесена в CoatingSuggestDTOTransformer (общий с
 * AllCoatingsForSuggest — офлайн-каталог), чтобы shape подсказки жил в одном месте.
 */
