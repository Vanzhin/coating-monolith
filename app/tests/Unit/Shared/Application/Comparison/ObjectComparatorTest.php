...
final class ObjectComparatorTest extends TestCase
{
    ...
    public function test_throws_when_fewer_than_two_objects(): void
    {
    ...
    public function test_scalar_fields_differ_marked_different(): void
    {
        $make = fn (int $v) => new class($v) {
    ...
    public function test_structurally_equal_value_objects_marked_not_different(): void
    {
        $vo1 = new readonly class(10, 20) {
            public function __construct(public int $min, public int $max)
            {
            }
        };
        $vo2 = new $vo1(10, 20);
        $owner1 = new class($vo1) {
            public function __construct(public object $range)
            {
            }
        };
    ...
    public function test_nested_property_path(): void
    {
        ...
        $inner1 = $makeInner();
        $inner2 = new $inner1();
        $makeOuter = fn (object $dft) => new class($dft) {
            public function __construct(public object $dft)
            {
            }
        };
        $a = $makeOuter($inner1);
    ...
    public function test_three_objects_all_equal(): void
    {
        $make = fn (int $v) => new class($v) {
            public function __construct(public int $x)
            {
    ...
    public function test_three_objects_one_differs(): void
    {
        $make = fn (int $v) => new class($v) {
            public function __construct(public int $x)
            {
